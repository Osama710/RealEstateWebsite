...
<body>
    ...
    <div class="container-fluid w-100 p-3 buyy">
        <h1 class="buy mb-3">Find Properties on Rent</h1>
        <form action="" method='post'>
            <div class="row shadow p-3 mb-5 rounded bggg">
                ...
                <select class="form-control" name="bed">
                    <?php 
                        $sql2 = mysqli_query($conn, "SELECT NumberOfRooms FROM houselisting");
            ...
            <div class='col-md-4 col-md-6 col-lg-4 mb-4'>
                <div class='card m-2 rounded img-zoom' style='width: 21rem;'>
                    <div class="card-img-caption">
                        <p class="card-text m-2 p-2 type2 rounded-pill">On Rent</p>
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <p class="card-text">Available On Rent in a perfect Location. Best for your Family.</p>
